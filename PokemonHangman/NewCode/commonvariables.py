...
game_font_name = "Pokemon Solid Normal,PokemonSolid,Comic Sans MS,Tempus Sans ITC"
game_colors = {'yellow':pygame.Color(255,255,0), 'green':pygame.Color(0,102,0),'orange':pygame.Color(255,102,0),'red':pygame.Color(204,0,0),
				'pink':pygame.Color(255,0,102),'blue':pygame.Color(51,0,204),'black':pygame.Color(0,0,0),'white':pygame.Color(255,255,255)}
